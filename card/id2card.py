...
ID2CARD_DICT = {
    ...
    InjuredTolvir.id: InjuredTolvir,
    RelentlessWorg.id: RelentlessWorg,
    TarCreeper.id: TarCreeper,
    ChillwindYeti.id: ChillwindYeti,
    ImposingAnubisath.id: ImposingAnubisath,
    SaroniteTolvir.id: SaroniteTolvir,
    RottenApplebaum.id: RottenApplebaum,
    TaelanFording.id: TaelanFording,
    DrBoom.id: DrBoom,
    PrimordianlDrake.id: PrimordianlDrake,
    SleepyDragon.id: SleepyDragon,
